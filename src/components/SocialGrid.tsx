...
export function SocialGrid(): React.ReactElement {
  ...
  return (
    <nav aria-label="Social media links" className="flex justify-center gap-4 pb-safe">
