...
export function AnimatedProjectCard({
  ...
  return (
    <motion.a
      ...
      className={`relative flex flex-col gap-3 overflow-hidden rounded-xl border border-white/10 bg-[#0A0A0A] p-4 transition-colors before:pointer-events-none before:absolute before:inset-x-0 before:bottom-0 before:h-24 hover:border-white/20 ${glowStyles[glowColor]}`}
