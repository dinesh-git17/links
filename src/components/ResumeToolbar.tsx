...
export function ResumeToolbar({ shareUrl }: ResumeToolbarProps): React.ReactElement {
  ...
  const buttonBase =
    'flex items-center justify-center gap-2 rounded-full px-4 py-2.5 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-[color:var(--ring-color)] focus:ring-offset-2 focus:ring-offset-[color:var(--ring-offset)]';
